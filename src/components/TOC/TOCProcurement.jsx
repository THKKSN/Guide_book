      ...
      return (
        <div className="toc">
          ...
          <ul className=" space-y-2">
            {["overview", "accessing-procurement list", "managing-purchase requests(PR)","managing-purchase orders(PO)","creating-new purchase order","reviewing-PO details","PO-approval process","product-price","report"].map((id) => (
              <li key={id}>
                <button
